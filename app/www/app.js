...
var _user$project$Data_Story$storyIdDecoder = _elm_lang$core$Json_Decode$int;
var _user$project$Data_Story$storyIdToString = function (id) {
	return _elm_lang$core$Basics$toString(id);
};
var _user$project$Data_Story$Story = F5(
	function (a, b, c, d, e) {
		return {id: a, by: b, url: c, title: d, descendants: e};
	});
var _user$project$Data_Story$decoder = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$Data_Story$Story,
	A2(_elm_lang$core$Json_Decode$field, 'id', _user$project$Data_Story$storyIdDecoder),
...
var _user$project$Data_Story$Item = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Request_Story$apiRoot = 'https://hacker-news.firebaseio.com/v0';
var _user$project$Request_Story$fetchIds = function (endpoint) {
	return A2(
		_elm_lang$http$Http$get,
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Request_Story$apiRoot,
				...
				A2(
					...
					function (_p0) {
						return _elm_lang$http$Http$toTask(
							_user$project$Request_Story$fetchStory(_p0));
					},
					ids)));
	});

var _user$project$Main$renderStory = function (_p0) {
	var _p1 = _p0;
	var _p5 = _p1.title;
	var _p4 = _p1.id;
			...
			{ctor: '[]'},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Data_Story$storyIdToString(_p4),
