...
var _mfeineis$elm_hn_app$Data_Story$storyIdDecoder = _elm_lang$core$Json_Decode$int;
var _mfeineis$elm_hn_app$Data_Story$storyIdToString = function (id) {
	return _elm_lang$core$Basics$toString(id);
};
var _mfeineis$elm_hn_app$Data_Story$Story = F5(
	function (a, b, c, d, e) {
		return {id: a, by: b, url: c, title: d, descendants: e};
	});
var _mfeineis$elm_hn_app$Data_Story$decoder = A6(
	_elm_lang$core$Json_Decode$map5,
	_mfeineis$elm_hn_app$Data_Story$Story,
	A2(_elm_lang$core$Json_Decode$field, 'id', _mfeineis$elm_hn_app$Data_Story$storyIdDecoder),
...
var _mfeineis$elm_hn_app$Data_Story$Item = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {id: a, deleted: b, type_: c, by: d, time: e, text: f, dead: g, parent: h, poll: i, kids: j, url: k, score: l, title: m, parts: n, descendants: o};
														};
													};
												};
											};
...
var _mfeineis$elm_hn_app$Request_Story$fetchIds = function (endpoint) {
	return A2(
		...
		A2(
			...
			_mfeineis$elm_hn_app$Request_Story$apiRoot,
			A2(_elm_lang$core$Basics_ops['++'], endpoint, '.json')),
		_elm_lang$core$Json_Decode$list(_mfeineis$elm_hn_app$Data_Story$storyIdDecoder));
};
var _mfeineis$elm_hn_app$Request_Story$fetchBestIds = _mfeineis$elm_hn_app$Request_Story$fetchIds('/beststories');
var _mfeineis$elm_hn_app$Request_Story$fetchNewIds = _mfeineis$elm_hn_app$Request_Story$fetchIds('/newstories');
var _mfeineis$elm_hn_app$Request_Story$fetchTopIds = _mfeineis$elm_hn_app$Request_Story$fetchIds('/topstories');
var _mfeineis$elm_hn_app$Request_Story$fetchStory = function (id) {
	return A2(
		_elm_lang$http$Http$get,
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_mfeineis$elm_hn_app$Data_Story$storyIdToString(id),
					'.json'))),
		_elm_lang$core$Json_Decode$maybe(_mfeineis$elm_hn_app$Data_Story$decoder));
};
var _mfeineis$elm_hn_app$Request_Story$fetchStories = F2(
	function (msg, ids) {
		return A2(
			_elm_lang$core$Task$attempt,
			msg,
				...
				A2(
					...
					function (_p0) {
						return _elm_lang$http$Http$toTask(
							_mfeineis$elm_hn_app$Request_Story$fetchStory(_p0));
					},
					ids)));
	});
...
var _mfeineis$elm_hn_app$Styled$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _mfeineis$elm_hn_app$Styled$navButton = F2(
	function (attrs, children) {
		return A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _mfeineis$elm_hn_app$Styled$styles(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(_rtfeldman$elm_css$Css_Colors$black),
						_1: {
							ctor: '::',
...
var _mfeineis$elm_hn_app$Styled$navButtonDisabled = F2(
	function (attrs, children) {
		return A2(
			_elm_lang$html$Html$a,
			{
...
var _mfeineis$elm_hn_app$Styled$navButtonSelected = F2(
	function (attrs, children) {
		return A2(
			_elm_lang$html$Html$a,
			{
...
var _mfeineis$elm_hn_app$Styled$navLogo = function (attrs) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$img,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt('Y combinator logo'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('https://news.ycombinator.com/y18.gif'),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _mfeineis$elm_hn_app$Styled$navTitle = F2(
	function (attrs, children) {
		return A2(
			_elm_lang$html$Html$a,
			{
...
var _mfeineis$elm_hn_app$Styled$pageFrame = F2(
	function (attrs, children) {
		return A2(
...
var _mfeineis$elm_hn_app$Styled$pageHeader = F2(
	function (attrs, children) {
		return A2(
...
var _mfeineis$elm_hn_app$Styled$pageMain = F2(
	function (attrs, children) {
		return A2(
				...
				_0: _mfeineis$elm_hn_app$Styled$styles(
					{
						...
						_0: _rtfeldman$elm_css$Css$backgroundColor(
							_rtfeldman$elm_css$Css$hex('f6f6ef')),
						_1: {
							ctor: '::',
...
var _mfeineis$elm_hn_app$Styled$storyItem = F2(
	function (attrs, children) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _mfeineis$elm_hn_app$Main$renderStory = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1.title;
	var descendantInfo = function () {
		var _p2 = _p1.descendants;
		if (_p2.ctor === 'Nothing') {
			return '';
		} else {
			if (_p2._0 === 0) {
	...
	if (_p3.ctor === 'Nothing') {
		return A2(
			_mfeineis$elm_hn_app$Styled$storyItem,
			{ctor: '[]'},
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(descendantInfo),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _mfeineis$elm_hn_app$Main$setStoryIds = F2(
	function (storyIds, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{storyIds: storyIds});
	});
var _mfeineis$elm_hn_app$Main$setStories = F2(
	function (stories, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{stories: stories});
	});
var _mfeineis$elm_hn_app$Main$resetStories = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			stories: {ctor: '[]'}
...
var _mfeineis$elm_hn_app$Main$getPage = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6.pageState;
	if (_p7.ctor === 'Loaded') {
		return _p7._0;
	} else {
		return _p7._0;
...
var _mfeineis$elm_hn_app$Main$Model = F3(
	function (a, b, c) {
		return {pageState: a, stories: b, storyIds: c};
	});
var _mfeineis$elm_hn_app$Main$TopStories = {ctor: 'TopStories'};
var _mfeineis$elm_hn_app$Main$NewStories = {ctor: 'NewStories'};
var _mfeineis$elm_hn_app$Main$BestStories = {ctor: 'BestStories'};
var _mfeineis$elm_hn_app$Main$Loading = function (a) {
	return {ctor: 'Loading', _0: a};
};
var _mfeineis$elm_hn_app$Main$setLoading = F2(
	function (page, _p8) {
		var _p9 = _p8;
		return _elm_lang$core$Native_Utils.update(
			_p9,
			{
				pageState: _mfeineis$elm_hn_app$Main$Loading(page)
			});
	});
var _mfeineis$elm_hn_app$Main$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _mfeineis$elm_hn_app$Main$setLoaded = function (_p10) {
	var _p11 = _p10;
	var _p12 = _p11;
	return _elm_lang$core$Native_Utils.update(
		_p12,
		{
			pageState: _mfeineis$elm_hn_app$Main$Loaded(
...
var _mfeineis$elm_hn_app$Main$navButton = F3(
	function (label, reference, pageState) {
		...
		if (_p15.ctor === 'Loaded') {
			return _elm_lang$core$Native_Utils.eq(reference, _p15._0) ? A2(
				_mfeineis$elm_hn_app$Styled$navButtonSelected,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_mfeineis$elm_hn_app$Main$ShowPage(reference)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
				...
				_mfeineis$elm_hn_app$Styled$navButton,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_mfeineis$elm_hn_app$Main$ShowPage(reference)),
			...
			return A2(
				_mfeineis$elm_hn_app$Styled$navButtonDisabled,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_mfeineis$elm_hn_app$Main$ShowPage(reference)),
		...
		_0: _mfeineis$elm_hn_app$Styled$navLogo(
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_mfeineis$elm_hn_app$Main$ShowPage(_mfeineis$elm_hn_app$Main$NewStories)),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_mfeineis$elm_hn_app$Styled$navTitle,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_mfeineis$elm_hn_app$Main$ShowPage(_mfeineis$elm_hn_app$Main$NewStories)),
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Hacker News'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _mfeineis$elm_hn_app$Main$view = function (_p19) {
	...
	return A2(
		_mfeineis$elm_hn_app$Styled$pageFrame,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
			...
			_1: {
				ctor: '::',
				_0: A2(
					_mfeineis$elm_hn_app$Styled$pageMain,
					{ctor: '[]'},
					storyList),
				_1: {ctor: '[]'}
			}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mfeineis$elm_hn_app$Main$main !== 'undefined') {
    _mfeineis$elm_hn_app$Main$main(Elm['Main'], 'Main', undefined);
}
